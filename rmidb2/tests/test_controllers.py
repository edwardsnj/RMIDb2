...
See http://docs.turbogears.org/1.5/Testing#testing-your-controller for more
information.
...
class TestPages(testutil.TGTest):
    ...
    def test_login_and_logout(self):
        ...
        u = User(user_name=u"scott", password=u"tiger",
            display_name=u"Bruce Scott", email_address=u"scott@enterprise.com")
        response = self.app.get('/')
