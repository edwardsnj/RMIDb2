...
to do this before you import your model, e.g.::
    ...
    from rmidb2.model import YourModelClass, User, ...

See http://docs.turbogears.org/1.5/Testing#testing-your-model for more
information.
...
try:
    from rmidb2.model import User, create_tables, create_default_user
except ImportError:
    import warnings
