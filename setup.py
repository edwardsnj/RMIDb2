...
package_data = find_package_data(where='rmidb2',
    package='rmidb2')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-rmidb2 = rmidb2.command:start',
            # See the rmidb2.command.bootstrap function for details
